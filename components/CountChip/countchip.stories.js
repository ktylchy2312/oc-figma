// Generated from the Figma component "CountChip". Do not hand-edit.
...
export default {
  title: "Cards and rows/CountChip",
  tags: ['autodocs'],
  parameters: {
    docs: { description: { component: "Generated from the Figma component  `CountChip` (page: Page 2).\n\nRoot element `<span>`, base class `.oc-countchip`.\n1 variant.\n\nValues come from the Figma bindings; nothing here is hand-tuned. Full property table in the\ncomponent's [README](../../components/CountChip/README.md)." } },
  },
};
