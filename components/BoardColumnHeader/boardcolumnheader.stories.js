...
export default {
  title: "Dashboard/BoardColumnHeader",
  tags: ['autodocs'],
  parameters: {
    docs: { description: { component: "Generated from the Figma component  `BoardColumnHeader` (page: Page 2).\n\nRoot element `<header>`, base class `.oc-boardcolumnheader`.\n1 variant.\n\nValues come from the Figma bindings; nothing here is hand-tuned. Full property table in the\ncomponent's [README](../../components/BoardColumnHeader/README.md)." } },
  },
};
