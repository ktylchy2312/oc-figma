...
const TEXT_PARTS = {"oc-board-column-header__label":"Label","oc-board-column-header__count":"Count"};
const OPTIONAL_PARTS = {};

export default {
  title: "Stage/BoardColumnHeader",
  tags: ["autodocs"],
  parameters: {
    docs: { description: { component: "Компонент «BoardColumnHeader»\n\nСобрано из спеки Figma `448:8151` (страница Core).\nКорень `<div>`, базовый класс `.oc-board-column-header`. Вариантов: 1. Непривязанных значений: 6 — см. маркеры TODO в CSS." } },
  },
  argTypes: {
    "Label": {
...
export const Playground = {
  render: (args) => {
    ...
    wrap.innerHTML = VARIANTS["BoardColumnHeader"] ?? "<p>нет такой комбинации</p>";
