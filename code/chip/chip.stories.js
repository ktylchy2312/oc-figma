// Chip — сгенерировано из components/chip/spec.json. Руками не править.
...
const VARIANTS = {
  "Neutral": `
    <div class="oc-chip oc-chip--variant-neutral">
      <span class="oc-chip__label">3/5</span>
    </div>
  `,
  "Code": `
    <div class="oc-chip oc-chip--variant-code">
      <span class="oc-chip__3-5">3/5</span>
    </div>
  `
};

const CAPTIONS = ["Variant=Neutral","Variant=Code"];

// класс части → имя свойства Figma, которое ею управляет
const TEXT_PARTS = {"oc-chip__label":"Label"};
...
export default {
  ...
  tags: ["autodocs"],
  parameters: {
    docs: { description: { component: "Neutral — обычная метка, круглая. Code — код или сигнатура, квадратная (Radius/sm).\n\nСобрано из спеки Figma `41:1750` (страница Core).\nКорень `<div>`, базовый класс `.oc-chip`. Вариантов: 2. Непривязанных значений: 1 — см. маркеры TODO в CSS." } },
  },
  argTypes: {
    "Variant": {
      description: "Свойство варианта Figma «Variant»",
      control: { type: "inline-radio" },
      options: ["Neutral","Code"],
    },
    "Label": {
