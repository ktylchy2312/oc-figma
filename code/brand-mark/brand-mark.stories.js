// BrandMark — сгенерировано из components/brand-mark/spec.json. Руками не править.
...
export default {
  ...
  tags: ["autodocs"],
  parameters: {
    docs: { description: { component: "Компонент «BrandMark»\n\nСобрано из спеки Figma `448:11207` (страница Core).\nКорень `<div>`, базовый класс `.oc-brand-mark`. Вариантов: 1. Непривязанных значений: 3 — см. маркеры TODO в CSS." } },
  },
  argTypes: {
...
export const Playground = {
  render: (args) => {
    ...
    wrap.innerHTML = VARIANTS["BrandMark"] ?? "<p>нет такой комбинации</p>";
