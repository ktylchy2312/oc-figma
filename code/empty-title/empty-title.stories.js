// EmptyTitle — сгенерировано из components/empty-title/spec.json. Руками не править.
import "../../foundations/fonts.css";
import "../../foundations/tokens.css";
import "../../foundations/typography.css";
import "../base.css";
import "./empty-title.css";

const VARIANTS = {
  "EmptyTitle": `
    <div class="oc-empty-title">
      <span class="oc-empty-title__label">Brak pojazdów na tym etapie</span>
    </div>
  `
};
...
const TEXT_PARTS = {"oc-empty-title__label":"Label"};
...
export default {
  ...
  tags: ["autodocs"],
  parameters: {
    docs: { description: { component: "Компонент «EmptyTitle»\n\nСобрано из спеки Figma `33:1541` (страница Core).\nКорень `<div>`, базовый класс `.oc-empty-title`. Вариантов: 1." } },
  },
  argTypes: {
    "Label": {
  ...
  args: {
    "Label": "Brak pojazdów na tym etapie",
  },
};
...
export const Playground = {
  render: (args) => {
    ...
    wrap.innerHTML = VARIANTS["EmptyTitle"] ?? "<p>нет такой комбинации</p>";
